...
interface SlackNotificationServiceContract
{
     ...
     *
     * @param ClientStatusfactionUpdate $statusUpdate The status update that was submitted
     * @return array{success: bool, notification_id?: int, error?: string}
     */
     ...
     *
     * @param ClientStatusfactionUpdate $statusUpdate The status update that was approved
     * @return array{success: bool, notification_id?: int, error?: string}
     */
