...
<head>
    ...
    <title>User Management - Joy Admin</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-green-600">{{ $users->where('role', 'admin')->count() }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">Agency Users</h3>
                                <p class="text-2xl font-bold text-purple-600">{{ $users->where('role', 'agency')->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                    ...
                                                    @elseif($user->role === 'agency') bg-purple-100 text-purple-800
