    ...
    <div :class="sidebarOpen ? 'w-64' : 'w-16'" class="bg-white dark:bg-neutral-800 border-r border-neutral-200 dark:border-neutral-700 transition-all duration-300 flex flex-col">
      ...
      <nav class="flex-1 p-4 space-y-2">
        ...
        @if($this->hasPermission('access statusfaction'))
          <a href="/statusfaction" class="flex items-center gap-3 px-3 py-2 rounded-lg text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition group">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
